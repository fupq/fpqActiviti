...
class AsignTaskGroup {
	...
	public void deployStudentLeaveApplyProcess() {
		...
		.addClasspathResource("diagrams/activiti_applyLeave_assignmentTask_group.bpmn") //加载工作流资源文件
		.addClasspathResource("diagrams/activiti_applyLeave_assignmentTask_group.png") //加载工作流资源文件
		.name("学生请假电子流_使用组（角色）分配任务-流程中指定") //设置工作流程的名称
		.deploy();//部署
	...
	public void start(){
		ProcessInstance pi=processEngine.getRuntimeService() // 运行时Service
			.startProcessInstanceByKey("activitiAssignmentTaskGroup"); // 流程定义表的KEY字段值：myProcess
