...
class AsignTaskPerson {
	...
	public void deployStudentLeaveApplyProcess() {
		...
		.addClasspathResource("diagrams/activiti_applyLeave_assignmentTask.bpmn") //加载工作流资源文件
		.addClasspathResource("diagrams/activiti_applyLeave_assignmentTask.png") //加载工作流资源文件
		.name("学生请假电子流_分配任务指定某人") //设置工作流程的名称
		.deploy();//部署
	...
	public void start(){
		ProcessInstance pi=processEngine.getRuntimeService() // 运行时Service
			.startProcessInstanceByKey("activitiAssignmentTask"); // 流程定义表的KEY字段值：myProcess
