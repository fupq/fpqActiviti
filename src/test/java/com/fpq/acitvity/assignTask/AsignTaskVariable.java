...
class AsignTaskVariable {
	...
	public void deployStudentLeaveApplyProcess() {
		...
		.addClasspathResource("diagrams/activiti_applyLeave_assignmentTaskVariable.bpmn") //加载工作流资源文件
		.addClasspathResource("diagrams/activiti_applyLeave_assignmentTaskVariable.png") //加载工作流资源文件
		.name("学生请假电子流_分配任务到流程变量") //设置工作流程的名称
		.deploy();//部署
	...
	public void start(){
		try {
			...
			map.put("userid", "id_carson");
			ProcessInstance pi=processEngine.getRuntimeService() // 运行时Service
					.startProcessInstanceByKey("activitiAssignmentTaskVariable", map); //代初始化变量方式启动流程
