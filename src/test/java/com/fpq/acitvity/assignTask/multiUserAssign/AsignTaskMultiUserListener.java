...
import com.fpq.acitvity.assignTask.AssigneeTaskListener;
 ...
 *
 */
class AsignTaskMultiUserListener {
	...
	public void deployStudentLeaveApplyProcess() {
		...
		.addClasspathResource("diagrams/activiti_applyLeave_assignmentTask_multiUserListener.bpmn") //加载工作流资源文件
		.addClasspathResource("diagrams/activiti_applyLeave_assignmentTask_multiUserListener.png") //加载工作流资源文件
		.name("学生请假电子流_多用户任务分配_使用监听器") //设置工作流程的名称
		.deploy();//部署
	...
	public void start(){
		try {
			AssigneeTaskListener assigneeTaskListener = new AssigneeTaskListener();
			assigneeTaskListener.setAssignee("付柯翔"); //设置监听器
			ProcessInstance pi=processEngine.getRuntimeService() // 运行时Service
				.startProcessInstanceByKey("activitiAssignmentTaskMultiUserListener"); // 流程定义表的KEY字段值：myProcess
	...
	public void completeTask(){
		try {
			AssigneeTaskMultiUserListener lsn = new AssigneeTaskMultiUserListener();
