...
class GateWayExclusive {
	...
	public void deployStudentLeaveApplyProcess() {
		...
		.addClasspathResource("diagrams/StudentApplyLeave_gateway_exclusive.bpmn") //加载工作流资源文件
		.addClasspathResource("diagrams/StudentApplyLeave_gateway_exclusive.png") //加载工作流资源文件
		.name("学生请假电子流_排它网关") //设置工作流程的名称
		.deploy();//部署
	...
	public void start(){
		ProcessInstance pi=processEngine.getRuntimeService() // 运行时Service
			.startProcessInstanceByKey("studentApplyLeave_gateway_exclusive"); // 流程定义表的KEY字段值：myProcess
	...
	public void findHistoryProcessInstanceId() {
		...
		.processInstanceId("185001") //根据任务id查询
		.finished() //查询已经完成的任务
		.list();
