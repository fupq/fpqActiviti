...
class AsignTaskListener {
	...
	public void deployStudentLeaveApplyProcess() {
		...
		.addClasspathResource("diagrams/activiti_applyLeave_assignmentTaskListener.bpmn") //加载工作流资源文件
		.addClasspathResource("diagrams/activiti_applyLeave_assignmentTaskListener.png") //加载工作流资源文件
		.name("学生请假电子流_使用监听器分配任务") //设置工作流程的名称
		.deploy();//部署
	...
	public void start(){
		...
		assigneeTaskListener.setAssignee("付柯翔");
		ProcessInstance pi=processEngine.getRuntimeService() // 运行时Service
			.startProcessInstanceByKey("activitiAssignmentTaskListener"); // 流程定义表的KEY字段值：myProcess
	...
	public void completeTask(){
		AssigneeTaskListener assigneeTaskListener = new AssigneeTaskListener();
		assigneeTaskListener.setAssignee("付品欣");
	...
	public void findHistoryTask() {
		...
		.processInstanceId("252501") //根据任务id查询
		.finished() //查询已经完成的任务
		.list();
