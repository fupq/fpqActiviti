 ...
 * 
 */
package com.fpq.acitvity.gateway;
...
class LineTest {
	...
	public void deployStudentLeaveApplyProcess() {
		...
		.addClasspathResource("diagrams/StudentApplyLeave_gateway.bpmn") //加载工作流资源文件
		.addClasspathResource("diagrams/StudentApplyLeave_gateway.png") //加载工作流资源文件
		.name("学生请假电子流_网关") //设置工作流程的名称
		.deploy();//部署
	...
	public void start(){
		ProcessInstance pi=processEngine.getRuntimeService() // 运行时Service
			.startProcessInstanceByKey("studentApplyLeave_gateway"); // 流程定义表的KEY字段值：myProcess
	...
	public void completeTaskSetVariable(){
		...
		map.put("days3", 3);
		map.put("startDate3", new Date());
		map.put("reason3", "生病了，需要住院治疗");
		map.put("student3", junpu);
		map.put("msg", "一般情况");
		
		processEngine.getTaskService() // 任务相关Service
			.complete("135004", map); //完成任务时设置变量
	}
